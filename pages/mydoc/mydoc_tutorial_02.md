...
Once you are in Nvim the most important commands are:
...
1. Log into your user account on HPCC and copy and execute these [install commands](http://biocluster.ucr.edu/~tgirke/Documents/R_BioCond/My_R_Scripts/vim-r-plugin/README_nvimRtmux) from the command-line (_e.g._ copy & paste).
